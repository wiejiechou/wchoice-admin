...
import type { ServiceOrderForm, ServiceRegion } from "./types";
...
export function useServiceOrderForm(initialData?: Partial<ServiceOrderForm>) {
  const form = reactive<ServiceOrderForm>({
